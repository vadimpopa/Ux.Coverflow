Ext.define('Ux.Coverflow',{
    ...
    applyTpl: function(config){
        ...
        return new Ext.XTemplate('<tpl for="."><div data-idx="{storeIdx}" class="' + this.getItemBaseCls() + ' ' + this.getItemCls() + '">'+config+'</div></tpl>');
    },
    ...
    bufferItem: function(idx,direction) {
        ...
        item = this.getViewItems()[updateIdx];

        item.innerHTML = new Ext.XTemplate(me.createItemTpl()).apply(record.getData(true));
